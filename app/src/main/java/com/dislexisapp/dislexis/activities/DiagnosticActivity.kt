...
class DiagnosticActivity : AppCompatActivity(), PreguntaFragment.OnFragmentInteractionListener {
    ...
    override fun repetirPregunta() {
        mTTS.speak(preguntasList[contadorPregunta].pregunta , TextToSpeech.QUEUE_FLUSH, null)
    }

    fun initMainFragment(numPregunta: Int) {
        mTTS.speak(preguntasList[numPregunta].pregunta, TextToSpeech.QUEUE_FLUSH, null)
